...
const TransactionHistory = ({transaction}) => {
  ...
  return (
    ...
    <label htmlFor="" className="text-left mt-0 text-sm font-bold text-red-800 block">Transaction amount (withdrawal)</label>
      ...
      <div  className="bg-white mx-auto px-20 py-10 p-8 border border-black mb-2" title='Transaction Amount Withdrawal'>
      <p className='text-lg font bold text-black'>Transfered [{transaction.negativeAmount}] from account [{transaction.account_id}] </p>     
      ...
      <div className="bg-white mx-auto px-20 py-10 p-4 border border-black mb-2" title='Transaction Amount Deposit'>
